...
Règles :
- Si la nouvelle mémoire remplace une ancienne information, réponds UPDATE.
- Si elle répète une information déjà présente, réponds DOUBLON.
- Si elle ajoute une information réellement nouvelle, réponds NEW.
- Ne mets aucune explication.
- Respecte exactement les labels : Classification, File, Old, New.
